        ...
        <div className="flex items-center justify-center min-h-screen bg-black">
            <div className="bg-black p-8 rounded-lg shadow-md w-full max-w-md border-4 border-orange-500">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        <label htmlFor="email" className="block text-white-300 mb-1">Email:</label>
                        <input
                            type="email"
                            id="email"
                            name="email"
                    ...
                    <div>
                        <label htmlFor="password" className="block text-white-300 mb-1">Password:</label>
                        <input
                            type="password"
                            id="password"
                            name="password"
                            value={password}
                            onChange={handleChange}
                            className="w-full px-3 py-2 border border-white-300 rounded focus:outline-none focus:ring-2 focus:ring-orange-400"
                        />
                    </div>
                    <div>
                        <label htmlFor="confirmPassword" className="block text-white-300 mb-1">Confirm Password:</label>
                        <input
                            type="password"
                            id="confirmPassword"
